 ...
 * @author Admin
 */
public class Operations_Frame extends javax.swing.JFrame {

    /**
     * Creates new form Operations_Frame
     */
    public Operations_Frame() {
        super("Operations Frame");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/video_integrity/Operation_Background.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Operations_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Operations_Frame().setVisible(true);
            }
        });
    }

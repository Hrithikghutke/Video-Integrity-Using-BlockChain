...
public class User_Update extends javax.swing.JFrame {
    ...
    public User_Update() 
    {
        ...
        Data_Fetcher_User id = new Data_Fetcher_User();
        ArrayList al = id.toFetch(uid);
        String name = (String) al.get(0);
        String email = (String) al.get(1);
        String mob = (String) al.get(2);
        String userid = (String) al.get(3);
        String pw = (String) al.get(4);
...
public static String data1[][];
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED), javax.swing.BorderFactory.createTitledBorder(null, "Update User Info", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 153, 0)))); // NOI18N
        ...
        jPanel1.setBounds(590, 160, 360, 310);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/video_integrity/WebSecurity_thumb.jpg"))); // NOI18N
        getContentPane().add(jLabel4);
        jLabel4.setBounds(0, -300, 1810, 1600);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            Update_User_DB id = new Update_User_DB();
            if(id.isInserted(name, email, mob, userid, pw))
            {

...
import static video_integrity.View_History.data1;

/**
 *
 * @author Admin
 */
public class View_Download_Hist extends javax.swing.JFrame {

    /**
     * Creates new form View_Download_Hist
     */
    public View_Download_Hist() {
        super("View_Download_Hist");
        initComponents();
        String colname[] = {"Video_Name", "Time", "userid"};
        View_Download_Files df = new View_Download_Files();
        df.getAll();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Video File Name", "Time & Date", "Userid"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1);
        jScrollPane1.setBounds(250, 270, 831, 282);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/video_integrity/cybersecurity-po.jpg"))); // NOI18N
        jPanel1.add(jLabel1);
        jLabel1.setBounds(-60, -480, 5500, 3750);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Download_Hist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_Download_Hist().setVisible(true);
            }
        });
    }
